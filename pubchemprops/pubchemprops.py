...
def get_second_layer_props_from_cid(compound_cid, required_properties):
    """
        1. Accepts the compound CID
        2. Searches PubChem for data for the specified CID
        3. Cycles through the fetched data to select required fields
        4. Returns a dictionary with specified properties of specified compound
